      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
           <span class="app-brand-text demo menu-text fw-bolder ms-2 text-center">Church Schedules</span>
                             ...
                             <div class="row">
                              ...
                              <div class="row g-2">
                                <div class="col mb-0">
                                    ...
                                    <input type="text"name="sponsor"  class="form-control" placeholder="Enter here" />
                                </div>
                                 <div class="row g-2">
    ...
    <script >
      $(document).ready(function() {
        ...
        $('deletebtn').on('click', function(){
          ...
          var data = $tr.staff("td").map(function(){
           return $(this).text(); 
          }).get();
