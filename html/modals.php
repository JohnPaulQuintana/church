          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="modals.php" class="menu-link">
                    <div data-i18n="schedule">Update area</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <div class="card-body">
                  <div class="row gy-3">
                    ...
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold">Schedule</small>
                      <div class="mt-3">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Set schedule here</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row g-2">
                                  <div class="col mb-0">
                                    ...
                                    <input type="text" id="sponsor" class="form-control" placeholder="Enter here" />
                                  </div>
                                  <div class="row g-2">
                      ...
                      <div class="mt-3">
                        ...
                        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                          ...
                          <form action="addstaff.php" method="post">>
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Add here</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-bs-dismiss="modal"
                            ...
                            <div class="col">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="ifpriest" value="" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Check me if it's a Priest
                                        </label>
                                    </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold">Services</small>
                      <div class="mt-3">
                        <!-- Button trigger modal -->
                        ...
                        <div class="modal modal-top fade" id="modalTop" tabindex="-1">
                            ...
                            <label for="file" class="btn btn-tertiary js-labelFile">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="submit" mane="save" class="btn btn-primary">Save</button>
                              </div>
                            </form>
                          </div>
                        </div>
                 ...
                 <!-- Slide from Top Modal -->
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold">News</small>
                      <div class="mt-3">
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTop">
                          Update
                        ...
                        <div class="modal modal-top fade" id="modalTop" tabindex="-1">
                          <div class="modal-dialog">
                            <form class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalTopTitle">Update here</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-bs-dismiss="modal"
