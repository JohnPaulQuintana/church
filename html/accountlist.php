            ...
            ?>
               ...
               <?php
                   ...
                   <td><?php echo $i+1; ?></td>
                    ...
                    <td>
                    <a href="activeacc.php?id=<?php echo $row["id"];?>&&stat=<?php echo $row["status"];?>" title='diactivate'><span  class="btn btn-primary"><?php if($row['status']==1){echo "activate";} else { echo "diactivate";} ?></span></a>
                   
                    <a href="deleteacc.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure to delete?')" ><button type="button" name="delete" class="btn btn-danger deletebtn">Delete</button></td>     
