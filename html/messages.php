...
<div class="card">
            <h3 class="card-header text-center">List of Messages</h3>
            <div class='row'>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel1"><b>Message</b></h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>

          <div class="modal-body p-2 text-center">
              <h5 class="" id="name">Popover in a modal</h5>
              <!-- <hr class="text-secondary"> -->
              <h5 class="text-secondary" id="msg">Popover in a modal</h5>
          </div>
    ...
    <!-- / Layout wrapper -->
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal7" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                ...
                mysqli_query($conn,"SELECT * FROM contactus  WHERE ID='" . $ID . "'");
                ...
                ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-success" role="alert">
                                        <h4 class="alert-heading">Inbox</h4>
                                        <p><td><?php echo $_GET['message']; ?></td></p>
                                        <hr>
...
$(document).ready(function () {
  $('.view_btn').click(function (e) {
    ...
    var message_id = $(this).closest('tr').find('.message_id').text();
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('.message_viewing_data').html(response);
        $('#viewmesmodal').modal('show');
      }
    });
  });
});
    ...
    <script src="../index/updatedBackend/public/messages.js"></script>
  </body>
</html>
